$Assignment1 = [PSCustomObject]@{
    Name = 'RMEP01-TUS-XX-XX-SP-E-0001-A1-P04'
    Spec = './SP/RMEP01-TUS-XX-XX-SP-E-0001-A1-P04.tex'
    HomeDir = './RMEP01/'
    Archive = 'RMEP01-TUS-XX-ZZ-IE-E-0001-A1-P04.zip'
    Dwg1Out = 'RMEP01/RMEP01-E-0001-A1-.pdf'
    Dwg1 = 'RMEP01-TUS-XX-ZZ-DR-E-0001-A1-P04.pdf'
}

$Assignment2 = [PSCustomObject]@{
    Name = 'RMEP02-TUS-XX-XX-SP-H-0001-A1-P04'
    Spec = './SP/RMEP02-TUS-XX-XX-SP-H-0001-A1-P04.tex'
    HomeDir = './RMEP02/'
    Archive = 'RMEP02-TUS-XX-ZZ-IE-H-0001-A1-P04.zip'
    Dwg1Out = 'RMEP02/RMEP02-H-0001-A1-.pdf'
    Dwg1 = 'RMEP02-TUS-XX-ZZ-DR-H-0001-A1-P04.pdf'
    Dwg2Out = 'RMEP02/RMEP02-H-0002-A1-.pdf'
    Dwg2 = 'RMEP02-TUS-XX-ZZ-DR-H-0002-A1-P04.pdf'
    Dwg3Out = 'RMEP02/RMEP02-H-0003-A1-.pdf'
    Dwg3 = 'RMEP02-TUS-XX-ZZ-DR-H-0003-A1-P04.pdf'
    Dwg4Out = 'RMEP02/RMEP02-H-0004-A1-.pdf'
    Dwg4 = 'RMEP02-TUS-XX-ZZ-DR-H-0004-A1-P04.pdf'

}

$Assignment3 = [PSCustomObject]@{
    Name = 'RMEP03-TUS-XX-XX-SP-M-0001-A1-P04'
    Spec = './SP/RMEP03-TUS-XX-XX-SP-M-0001-A1-P04.tex'
    HomeDir = './RMEP03/'
    Archive = 'RMEP03-TUS-XX-ZZ-IE-M-0001-A1-P04.zip'
    Dwg1Out = 'RMEP03/RMEP03-M-0001-A1-.pdf'
    Dwg1 = 'RMEP03-TUS-XX-ZZ-DR-M-0001-A1-P04.pdf'
    Dwg2Out = 'RMEP03/RMEP03-M-0002-A1-.pdf'
    Dwg2 = 'RMEP03-TUS-XX-ZZ-DR-M-0002-A1-P04.pdf'
    Dwg3Out = 'RMEP03/RMEP03-M-0003-A1-.pdf'
    Dwg3 = 'RMEP03-TUS-XX-ZZ-DR-M-0003-A1-P04.pdf'
}

$Assignment4 = [PSCustomObject]@{
    Name = 'RMEP04-TUS-XX-XX-SP-Y-0001-A1-P04'
    Spec = './SP/RMEP04-TUS-XX-XX-SP-Y-0001-A1-P04.tex'
    HomeDir = './RMEP04/'
    Archive = 'RMEP04-TUS-XX-ZZ-IE-Y-0001-A1-P04.zip'
    Dwg1Out = 'RMEP04/RMEP01-Y-0001-A1-.pdf'
    Dwg1 = 'RMEP04-TUS-XX-ZZ-DR-Y-0001-A1-P04.pdf'
}


$AssetLocation = './M3-DR/'
$Sheet = 'RMEPXX-TUS-XX-XX-DR-A-Zz_10-0001-P02.rfa'
$SheetA4 = 'RMEPXX-TUS-XX-XX-DR-A-Zz_10-0004-P02.rfa'
$ArchModel = 'RMEPXX-TUS-XX-ZZ-M3-A-0001-A1-P04.rvt'
