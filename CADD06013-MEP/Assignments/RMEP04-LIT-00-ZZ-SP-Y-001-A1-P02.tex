...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{./Assignments/img/FanCoilUnit.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{./Assignments/img/ParaBox1.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{./Assignments/img/ParaBox2.jpg}
	\caption{Generic Family Part}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{./Assignments/img/AutoRouteDuct.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{./Assignments/img/AutoRoutePipe.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{./Assignments/img/RevitSchedule.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{./Assignments/img/RevitLegend.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{./Assignments/img/FabParts.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{./Assignments/img/FabPartsReverse.jpg}
